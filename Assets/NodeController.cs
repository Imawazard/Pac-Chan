...
public class NodeController : MonoBehaviour
{
    ...
    public bool isRevivePellet = false; 
    ...
    {
        if (( (collision.tag == "Player" && gameManager.pacman != null) || (collision.tag == "Player2" && gameManager.pacman2 != null)) && hasPellet)
        {
            hasPellet = false;
            pelletSprite.enabled = false;
            StartCoroutine(gameManager.CollectedPellet(this, collision.tag));
        }
    }
}
